 ...
 * @LastEditTime: 2021-01-10 15:05:42
 * @LastEditors: HLLI8
 */
#include "app_rtc.h"
...
void RTC_Get_SysTime(void){
    ...
    Uart5_DMA_Sent(OutPutInfo_Container.Time_Info, sizeof(OutPutInfo_Container.Time_Info)/sizeof(OutPutInfo_Container.Time_Info[0]));
}
